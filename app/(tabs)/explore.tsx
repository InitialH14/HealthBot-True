  ...
  return (
    <ParallaxScrollView
      ...
      <Collapsible title="File-based routing">
        ...
        <ThemedText style={undefined} lightColor={undefined} darkColor={undefined}>
          The layout file in <ThemedText type="defaultSemiBold" style={undefined} lightColor={undefined} darkColor={undefined}>app/(tabs)/_layout.tsx</ThemedText>{' '}
      ...
      <Collapsible title="Images">
        <ThemedText style={undefined} lightColor={undefined} darkColor={undefined}>
          For static images, you can use the <ThemedText type="defaultSemiBold" style={undefined} lightColor={undefined} darkColor={undefined}>@2x</ThemedText> and{' '}
